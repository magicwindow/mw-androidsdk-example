...
public class ImageIndicatorView extends RelativeLayout {
     ...
     * 页面列表
     */
    private List<MWImageView> viewList = new ArrayList<MWImageView>();
    ...
    public void setupLayoutByDrawable(final List<Integer> resList) {
        ...
        if (len > 0) {
            for (int index = 0; index < len; index++) {
                final MWImageView pageItem = new MWImageView(getContext());
    ...
    private class MyPagerAdapter extends PagerAdapter {
        private List<MWImageView> pageViews = new ArrayList<MWImageView>();

        public MyPagerAdapter(List<MWImageView> pageViews) {
