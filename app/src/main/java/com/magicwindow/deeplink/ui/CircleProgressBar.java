 ...
 public class CircleProgressBar extends ImageView {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        final TypedArray a = context.obtainStyledAttributes(
                attrs, com.magicwindow.deeplink.R.styleable.CircleProgressBar, defStyleAttr,0);
        final float density = getContext().getResources().getDisplayMetrics().density;

        mBackGroundColor = a.getColor(
                com.magicwindow.deeplink.R.styleable.CircleProgressBar_mlpb_background_color, DEFAULT_CIRCLE_BG_LIGHT);

        mProgressColor = a.getColor(
                com.magicwindow.deeplink.R.styleable.CircleProgressBar_mlpb_progress_color, DEFAULT_CIRCLE_BG_LIGHT);//ToDO 默认颜色
        ...
        mProgressStokeWidth = a.getDimensionPixelOffset(
                com.magicwindow.deeplink.R.styleable.CircleProgressBar_mlpb_progress_stoke_width, (int) (STROKE_WIDTH_LARGE*density));
        ...
        mTextSize = a.getDimensionPixelOffset(
                com.magicwindow.deeplink.R.styleable.CircleProgressBar_mlpb_progress_text_size,  (int)(DEFAULT_TEXT_SIZE *density));
        mTextColor = a.getColor(
                com.magicwindow.deeplink.R.styleable.CircleProgressBar_mlpb_progress_text_color, Color.BLACK);

        mShowArrow = a.getBoolean(com.magicwindow.deeplink.R.styleable.CircleProgressBar_mlpb_show_arrow,false);
        mCircleBackgroundEnabled = a.getBoolean(com.magicwindow.deeplink.R.styleable.CircleProgressBar_mlpb_enable_circle_background,true);
        ...
        int textVisible = a.getInt(com.magicwindow.deeplink.R.styleable.CircleProgressBar_mlpb_progress_text_visibility,1);
        if(textVisible != 1){
           mIfDrawText = true;
        }
